...
export const Route = createRootRoute({
  head: () => ({
    meta: [
      ...
      { name: "description", content: "AgentSentinel protects enterprise AI agents from malicious indirect prompt injections in documents and emails." },
      { property: "og:description", content: "AgentSentinel protects enterprise AI agents from malicious indirect prompt injections in documents and emails." },
      { name: "twitter:description", content: "AgentSentinel protects enterprise AI agents from malicious indirect prompt injections in documents and emails." },
      ...
      { name: "twitter:image", content: "https://pub-bb2e103a32db4e198524a2e9ed8f35b4.r2.dev/ac323b2d-c57f-452e-9530-da08a3e7533f/id-preview-aa5c1e94--6a4ca9a3-c868-4256-9f32-3c041c0503af.lovable.app-1777971971347.png" },
